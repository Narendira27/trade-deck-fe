...
export const defaultTradeDetailColumns: TradeDetailColumn[] = [
  { id: "qty", label: "Qty", visible: true, width: "80px" },
  ...
  { id: "entrySpotPrice", label: "Entry Spot Price", visible: true, width: "130px" },
  ...
  { id: "takeProfitPremium", label: "TP Premium", visible: true, width: "100px" },
  { id: "pointOfAdjustment", label: "POA", visible: true, width: "80px" },
  { id: "pointOfAdjustmentLowerLimit", label: "POA Lower", visible: true, width: "100px" },
  { id: "pointOfAdjustmentUpperLimit", label: "POA Upper", visible: true, width: "100px" },
  { id: "entryTriggered", label: "Entry Triggered", visible: true, width: "120px" },
